...
#define BLINK_LED_INTERVAL_MS 1000
...
// START Buttons
const LedButtonConfig buttonConfigUp = {
    38, // buttonPin
    39  // ledPin
};
const LedButtonConfig buttonConfigCenter = {
    40, // buttonPin
    41  // ledPin
};
const LedButtonConfig buttonConfigDown = {
    42, // buttonPin
    43  // ledPin
};
// END Buttons

// How long do you need to keep the button pressend to get into service mode
#define SERVICE_MODE_BUTTON_PRESS_MS 5000
